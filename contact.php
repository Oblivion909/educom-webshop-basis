...
>>>>>>> cb77f5b (Updated issue #6)
                {
                    ...
                    if(empty($_POST[$_NumberEntered]))
                    {
                        $_NumberEnteredError = "Number is required";
                    }
                    
                    if(empty($_POST[$_Comment]))
                    {
...
=======
                if (!$_Valid) 
                {
                    ...
                    <label for="_Gender">What is your gender? <span class="error">* '. $_GenderError . '</span></label> 
                    <br>
                    <select name="_Gender" id="_Gender">
...
>>>>>>> cb77f5b (Updated issue #6)
                    ...
                    <span class="error">* <?php echo $_NameError;?></span>  <value=$_FullName>  <br><br>

                    <label class="MarginForAllingment" for="_EmailAdress">Email Address:</label>
                    <input type="text" id="_EmailAdress" name= "_EmailAdress"> 
                    <span class="error">* <?php echo $_EmailError;?></span>   <value=$_Email> <br><br>

                    <label class="MarginForAllingment" for="_PhoneNumber">Phone number:</label>
                    <input type="text" name="_PhoneNumber" >
                    <span class="error">* <?php echo $_NumberEnteredError;?>  <value=$_NumberEntered> </span> <br><br>

                    <label class="MarginForAllingment" for="_Message">Your message:</label>
                    <textarea name= "_Message" ></textarea>
                    <span class="error">* <?php echo $_CommentError;?></span>  <value=$_Comment> <br><br>
...
=======
                    <p> Please select your prefered method of communication </p> 
